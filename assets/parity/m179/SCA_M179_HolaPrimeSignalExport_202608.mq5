...
void OnStart()
{
   ...
   int count = CopyRates(_Symbol, _Period, D'2026.07.31 00:00:00',
                         D'2026.09.01 06:00:00', rates);
   if(count < 520)
   {
   ...
   int bars_file = FileOpen("SCA_M179_HolaPrime_EURUSD_H1_202608_bars.csv",
                            FILE_WRITE | FILE_CSV | FILE_ANSI, ',');
   int signals_file = FileOpen("SCA_M179_HolaPrime_EURUSD_H1_202608_signals.csv",
                               FILE_WRITE | FILE_CSV | FILE_ANSI, ',');
   ...
   for(int i = 0; i < count; i++)
   {
      ...
      // align with the complete August 2026 UTC calendar month in TradingView.
      if(rates[i].time < D'2026.08.01 03:00:00' ||
         rates[i].time >= D'2026.09.01 03:00:00')
         continue;
   ...
   int shift = iBarShift(_Symbol, _Period, D'2026.08.31 20:00:00', false);
   ChartNavigate(0, CHART_END, -shift);
   Comment("M179 | HolaPrime-Server1 EURUSD H1 | 01-31 Aug 2026 | SMA 3/5 | BULL green, BEAR red | signal only");
   ChartRedraw(0);
   Sleep(3000);
   bool shot = ChartScreenShot(0, "SCA_M179_HolaPrime_EURUSD_H1_202608_chart.png",
                               1600, 900, ALIGN_LEFT);
